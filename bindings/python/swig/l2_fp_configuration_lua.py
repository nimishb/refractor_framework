...
class L2FpConfigurationLua(full_physics_swig.l2_fp_configuration.L2FpConfiguration):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, L2FpConfigurationLua, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.l2_fp_configuration.L2FpConfiguration]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, L2FpConfigurationLua, name)
    __repr__ = _swig_repr
