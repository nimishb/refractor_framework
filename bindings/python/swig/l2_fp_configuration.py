...
_l2_fp_configuration.SHARED_PTR_DISOWN_swigconstant(_l2_fp_configuration)
...
class L2FpConfiguration(full_physics_swig.generic_object.GenericObject):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, L2FpConfiguration, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, L2FpConfiguration, name)
