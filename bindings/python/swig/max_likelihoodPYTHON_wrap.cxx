...
#define SWIGTYPE_p_FullPhysics__MaxLikelihood swig_types[1]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihood_t swig_types[19]
...
/*-----------------------------------------------
              @(target):= _max_likelihood.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__max_likelihood

#else
#  define SWIG_init    init_max_likelihood

#endif
#define SWIG_name    "_max_likelihood"
...
#include "max_likelihoodPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_MaxLikelihood(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::MaxLikelihood *arg1 = (FullPhysics::MaxLikelihood *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::MaxLikelihood > tempshared1 ;
  boost::shared_ptr< FullPhysics::MaxLikelihood > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_MaxLikelihood",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihood_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_MaxLikelihood" "', argument " "1"" of type '" "FullPhysics::MaxLikelihood *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::MaxLikelihood > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::MaxLikelihood > * >(argp1);
      arg1 = const_cast< FullPhysics::MaxLikelihood * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::MaxLikelihood > * >(argp1);
      arg1 = const_cast< FullPhysics::MaxLikelihood * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
...
SWIGINTERN PyObject *MaxLikelihood_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihood_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::MaxLikelihood))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::MaxLikelihood >("boost::shared_ptr< FullPhysics::MaxLikelihood > *"));
