...
class OcoMetFile(full_physics_swig.meteorology.Meteorology):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, OcoMetFile, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.meteorology.Meteorology]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, OcoMetFile, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, Fname, Hdf_sounding_id):
        ...
        """
        this = _oco_met_file.new_OcoMetFile(Fname, Hdf_sounding_id)
        try:
