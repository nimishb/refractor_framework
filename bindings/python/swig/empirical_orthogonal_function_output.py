...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_empirical_orthogonal_function_output', [dirname(__file__)])
        except ImportError:
            import _empirical_orthogonal_function_output
            return _empirical_orthogonal_function_output
        if fp is not None:
            try:
                _mod = imp.load_module('_empirical_orthogonal_function_output', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _empirical_orthogonal_function_output = swig_import_helper()
...
_empirical_orthogonal_function_output.SHARED_PTR_DISOWN_swigconstant(_empirical_orthogonal_function_output)
SHARED_PTR_DISOWN = _empirical_orthogonal_function_output.SHARED_PTR_DISOWN
...
class EmpiricalOrthogonalFunctionOutput(full_physics_swig.register_output_base.RegisterOutputBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, EmpiricalOrthogonalFunctionOutput, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.register_output_base.RegisterOutputBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EmpiricalOrthogonalFunctionOutput, name)
...
EmpiricalOrthogonalFunctionOutput_swigregister(EmpiricalOrthogonalFunctionOutput)
