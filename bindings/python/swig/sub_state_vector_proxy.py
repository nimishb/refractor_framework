...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_sub_state_vector_proxy', [dirname(__file__)])
        except ImportError:
            import _sub_state_vector_proxy
            return _sub_state_vector_proxy
        if fp is not None:
            try:
                _mod = imp.load_module('_sub_state_vector_proxy', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _sub_state_vector_proxy = swig_import_helper()
...
_sub_state_vector_proxy.SHARED_PTR_DISOWN_swigconstant(_sub_state_vector_proxy)
SHARED_PTR_DISOWN = _sub_state_vector_proxy.SHARED_PTR_DISOWN
...
class SubStateVectorProxy(_object):
    ...
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SubStateVectorProxy, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _sub_state_vector_proxy.delete_SubStateVectorProxy
