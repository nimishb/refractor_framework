...
_ground_coxmunk.SHARED_PTR_DISOWN_swigconstant(_ground_coxmunk)
...
class GroundCoxmunk(full_physics_swig.ground.SubStateVectorArrayGround):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, GroundCoxmunk, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.ground.SubStateVectorArrayGround]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, GroundCoxmunk, name)
    __repr__ = _swig_repr
