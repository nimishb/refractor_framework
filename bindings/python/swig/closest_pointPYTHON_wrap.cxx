...
/*-----------------------------------------------
              @(target):= _closest_point.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__closest_point

#else
#  define SWIG_init    init_closest_point

#endif
#define SWIG_name    "_closest_point"
...
#include "closest_pointPYTHON_wrap.h"
