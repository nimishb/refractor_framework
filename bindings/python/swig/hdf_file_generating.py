...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_hdf_file_generating', [dirname(__file__)])
        except ImportError:
            import _hdf_file_generating
            return _hdf_file_generating
        if fp is not None:
            try:
                _mod = imp.load_module('_hdf_file_generating', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _hdf_file_generating = swig_import_helper()
...
_hdf_file_generating.SHARED_PTR_DISOWN_swigconstant(_hdf_file_generating)
SHARED_PTR_DISOWN = _hdf_file_generating.SHARED_PTR_DISOWN
...
class HdfFileGenerating(full_physics_swig.generic_object.GenericObject):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, HdfFileGenerating, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, HdfFileGenerating, name)
    __repr__ = _swig_repr
    ...
    __swig_destroy__ = _hdf_file_generating.delete_HdfFileGenerating
    __del__ = lambda self: None
HdfFileGenerating_swigregister = _hdf_file_generating.HdfFileGenerating_swigregister
HdfFileGenerating_swigregister(HdfFileGenerating)
