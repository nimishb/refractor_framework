...
#define SWIGTYPE_p_FullPhysics__OcoEcmwf swig_types[5]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OcoEcmwf_t swig_types[24]
...
#include "oco_ecmwfPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_OcoEcmwf(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_OcoEcmwf",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OcoEcmwf_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_OcoEcmwf(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_OcoEcmwf",&obj0,&obj1)) SWIG_fail;
  {
...
static void *_p_FullPhysics__OcoEcmwfTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::Ecmwf *) ((FullPhysics::OcoEcmwf *) x));
}
...
static void *_p_FullPhysics__OcoEcmwfTo_p_FullPhysics__Ecmwf(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::Ecmwf *)  ((FullPhysics::OcoEcmwf *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__OcoEcmwf_tTo_p_boost__shared_ptrT_FullPhysics__Ecmwf_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::Ecmwf >(*(boost::shared_ptr< FullPhysics::OcoEcmwf > *)x);
}
...
static swig_cast_info _swigc__p_FullPhysics__Ecmwf[] = {  {&_swigt__p_FullPhysics__Ecmwf, 0, 0, 0},  {&_swigt__p_FullPhysics__OcoEcmwf, _p_FullPhysics__OcoEcmwfTo_p_FullPhysics__Ecmwf, 0, 0},{0, 0, 0, 0}};
