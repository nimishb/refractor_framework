...
_aerosol_extinction_linear.SHARED_PTR_DISOWN_swigconstant(_aerosol_extinction_linear)
...
class AerosolExtinctionLinear(full_physics_swig.aerosol_extinction_imp_base.AerosolExtinctionImpBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, AerosolExtinctionLinear, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.aerosol_extinction_imp_base.AerosolExtinctionImpBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, AerosolExtinctionLinear, name)
    __repr__ = _swig_repr
