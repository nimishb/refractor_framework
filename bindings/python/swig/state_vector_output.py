...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_state_vector_output', [dirname(__file__)])
        except ImportError:
            import _state_vector_output
            return _state_vector_output
        if fp is not None:
            try:
                _mod = imp.load_module('_state_vector_output', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _state_vector_output = swig_import_helper()
...
_state_vector_output.SHARED_PTR_DISOWN_swigconstant(_state_vector_output)
SHARED_PTR_DISOWN = _state_vector_output.SHARED_PTR_DISOWN
...
class StateVectorOutput(full_physics_swig.register_output_base.RegisterOutputBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, StateVectorOutput, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.register_output_base.RegisterOutputBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, StateVectorOutput, name)
...
StateVectorOutput_swigregister(StateVectorOutput)
