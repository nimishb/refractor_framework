...
_reference_vmr_apriori.SHARED_PTR_DISOWN_swigconstant(_reference_vmr_apriori)
...
class ReferenceVmrApriori(full_physics_swig.generic_object.GenericObject):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, ReferenceVmrApriori, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ReferenceVmrApriori, name)
    __repr__ = _swig_repr
