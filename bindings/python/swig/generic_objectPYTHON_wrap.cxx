...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GenericObject_t swig_types[14]
...
/*-----------------------------------------------
              @(target):= _generic_object.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__generic_object

#else
#  define SWIG_init    init_generic_object

#endif
#define SWIG_name    "_generic_object"
...
#include "generic_objectPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_GenericObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::GenericObject *arg1 = (FullPhysics::GenericObject *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::GenericObject > tempshared1 ;
  boost::shared_ptr< FullPhysics::GenericObject > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_GenericObject",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GenericObject_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_GenericObject" "', argument " "1"" of type '" "FullPhysics::GenericObject *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::GenericObject > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::GenericObject > * >(argp1);
      arg1 = const_cast< FullPhysics::GenericObject * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::GenericObject > * >(argp1);
      arg1 = const_cast< FullPhysics::GenericObject * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
...
SWIGINTERN PyObject *_wrap_new_GenericObject(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::GenericObject *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_GenericObject")) SWIG_fail;
  {
    try {
      result = (FullPhysics::GenericObject *)new FullPhysics::GenericObject();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
  ...
  {
    boost::shared_ptr<  FullPhysics::GenericObject > *smartresult = result ? new boost::shared_ptr<  FullPhysics::GenericObject >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GenericObject_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *GenericObject_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GenericObject_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static swig_cast_info _swigc__p_FullPhysics__GenericObject[] = {  {&_swigt__p_FullPhysics__GenericObject, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__GenericObject_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__GenericObject_t, 0, 0, 0},{0, 0, 0, 0}};
