...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_solar_absorption_table', [dirname(__file__)])
        except ImportError:
            import _solar_absorption_table
            return _solar_absorption_table
        if fp is not None:
            try:
                _mod = imp.load_module('_solar_absorption_table', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _solar_absorption_table = swig_import_helper()
...
_solar_absorption_table.SHARED_PTR_DISOWN_swigconstant(_solar_absorption_table)
SHARED_PTR_DISOWN = _solar_absorption_table.SHARED_PTR_DISOWN
...
class SolarAbsorptionTable(full_physics_swig.solar_absorption_spectrum.SolarAbsorptionSpectrum):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, SolarAbsorptionTable, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.solar_absorption_spectrum.SolarAbsorptionSpectrum]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SolarAbsorptionTable, name)
    __repr__ = _swig_repr
...
SolarAbsorptionTable_swigregister(SolarAbsorptionTable)
