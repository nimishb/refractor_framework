...
_model_state.SHARED_PTR_DISOWN_swigconstant(_model_state)
...
class ModelState(full_physics_swig.problem_state.ProblemState):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, ModelState, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.problem_state.ProblemState]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ModelState, name)
