...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_forward_model_cost_function', [dirname(__file__)])
        except ImportError:
            import _forward_model_cost_function
            return _forward_model_cost_function
        if fp is not None:
            try:
                _mod = imp.load_module('_forward_model_cost_function', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _forward_model_cost_function = swig_import_helper()
...
_forward_model_cost_function.SHARED_PTR_DISOWN_swigconstant(_forward_model_cost_function)
SHARED_PTR_DISOWN = _forward_model_cost_function.SHARED_PTR_DISOWN
...
class ForwardModelCostFunction(full_physics_swig.cost_function.CostFunction):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, ForwardModelCostFunction, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.cost_function.CostFunction]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ForwardModelCostFunction, name)
    __repr__ = _swig_repr
...
ForwardModelCostFunction_swigregister(ForwardModelCostFunction)
