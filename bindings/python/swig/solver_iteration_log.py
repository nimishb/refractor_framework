...
_solver_iteration_log.SHARED_PTR_DISOWN_swigconstant(_solver_iteration_log)
...
class SolverIterationLog(full_physics_swig.connor_solver.ObserverConnorSolver):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, SolverIterationLog, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.connor_solver.ObserverConnorSolver]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SolverIterationLog, name)
    __repr__ = _swig_repr
