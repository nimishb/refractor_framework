...
_iterative_solver_der.SHARED_PTR_DISOWN_swigconstant(_iterative_solver_der)
...
class IterativeSolverDer(full_physics_swig.iterative_solver.IterativeSolver):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, IterativeSolverDer, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.iterative_solver.IterativeSolver]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, IterativeSolverDer, name)
