...
#define SWIGTYPE_p_FullPhysics__AcosSoundingId swig_types[0]
...
#define SWIGTYPE_p_FullPhysics__GosatNoiseModel swig_types[8]
#define SWIGTYPE_p_FullPhysics__HdfFile swig_types[9]
#define SWIGTYPE_p_FullPhysics__HdfSoundingId swig_types[10]
#define SWIGTYPE_p_FullPhysics__HeritageFile swig_types[11]
#define SWIGTYPE_p_FullPhysics__Instrument swig_types[12]
#define SWIGTYPE_p_FullPhysics__NoiseModel swig_types[13]
...
#define SWIGTYPE_p_FullPhysics__ObserverT_FullPhysics__Instrument_t swig_types[16]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t swig_types[38]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t swig_types[46]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HdfFile_t swig_types[47]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HdfSoundingId_t swig_types[48]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t swig_types[49]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Instrument_t swig_types[50]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NoiseModel_t swig_types[51]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ObservableT_FullPhysics__Instrument_t_t swig_types[52]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ObservableT_FullPhysics__StateVector_t_t swig_types[53]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ObserverT_FullPhysics__Instrument_t_t swig_types[54]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Spectrum_t swig_types[58]
...
/*-----------------------------------------------
              @(target):= _gosat_noise_model.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__gosat_noise_model

#else
#  define SWIG_init    init_gosat_noise_model

#endif
#define SWIG_name    "_gosat_noise_model"
...
#include "gosat_noise_modelPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_GosatNoiseModel__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::HeritageFile *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::HeritageFile const > tempshared1 ;
  PyObject * obj0 = 0 ;
  FullPhysics::GosatNoiseModel *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_GosatNoiseModel",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
    // First check to see if all ready pointer type
    FullPhysics::HeritageFile *ptr;
    res1 = SWIG_ConvertPtrAndOwn(obj0, (void**)(&ptr), SWIGTYPE_p_FullPhysics__HeritageFile,  0 , &newmem);
    if (SWIG_IsOK(res1)) {
      arg1 = ptr;
    } else {
      res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t,  0 , &newmem);
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_GosatNoiseModel" "', argument " "1"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_GosatNoiseModel" "', argument " "1"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp1);
        delete reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp1);
        arg1 = const_cast< FullPhysics::HeritageFile * >(tempshared1.get());
      } else {
        arg1 = const_cast< FullPhysics::HeritageFile * >(reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp1)->get());
      }
    }
  }
  {
    try {
      result = (FullPhysics::GosatNoiseModel *)new FullPhysics::GosatNoiseModel((FullPhysics::HeritageFile const &)*arg1);
  ...
  {
    boost::shared_ptr<  FullPhysics::GosatNoiseModel > *smartresult = result ? new boost::shared_ptr<  FullPhysics::GosatNoiseModel >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_GosatNoiseModel__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::HeritageFile *arg1 = 0 ;
  FullPhysics::HeritageFile *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::HeritageFile const > tempshared1 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  boost::shared_ptr< FullPhysics::HeritageFile const > tempshared2 ;
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  FullPhysics::GosatNoiseModel *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OO:new_GosatNoiseModel",&obj0,&obj1)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
    // First check to see if all ready pointer type
  ...
  }
  {
    ...
    // First check to see if all ready pointer type
    FullPhysics::HeritageFile *ptr;
    res2 = SWIG_ConvertPtrAndOwn(obj1, (void**)(&ptr), SWIGTYPE_p_FullPhysics__HeritageFile,  0 , &newmem);
    if (SWIG_IsOK(res2)) {
      arg2 = ptr;
    } else {
      res2 = SWIG_ConvertPtrAndOwn(obj1, &argp2, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t,  0 , &newmem);
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_GosatNoiseModel" "', argument " "2"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_GosatNoiseModel" "', argument " "2"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp2);
        arg2 = const_cast< FullPhysics::HeritageFile * >(tempshared2.get());
      } else {
        arg2 = const_cast< FullPhysics::HeritageFile * >(reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp2)->get());
      }
    }
  }
  {
    try {
      result = (FullPhysics::GosatNoiseModel *)new FullPhysics::GosatNoiseModel((FullPhysics::HeritageFile const &)*arg1,(FullPhysics::HeritageFile const &)*arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_new_GosatNoiseModel__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::HdfFile *arg1 = 0 ;
  FullPhysics::AcosSoundingId *arg2 = 0 ;
  FullPhysics::Instrument *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::HdfFile const > tempshared1 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  boost::shared_ptr< FullPhysics::AcosSoundingId const > tempshared2 ;
  void *argp3 = 0 ;
  int res3 = 0 ;
  boost::shared_ptr< FullPhysics::Instrument const > tempshared3 ;
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  PyObject * obj2 = 0 ;
  FullPhysics::GosatNoiseModel *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OOO:new_GosatNoiseModel",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
    // First check to see if all ready pointer type
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_GosatNoiseModel" "', argument " "1"" of type '" "FullPhysics::HdfFile const &""'"); 
      }
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_GosatNoiseModel" "', argument " "1"" of type '" "FullPhysics::HdfFile const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  }
  {
    ...
    // Added mms
    // First check to see if all ready pointer type
    FullPhysics::AcosSoundingId *ptr;
    res2 = SWIG_ConvertPtrAndOwn(obj1, (void**)(&ptr), SWIGTYPE_p_FullPhysics__AcosSoundingId,  0 , &newmem);
    if (SWIG_IsOK(res2)) {
      arg2 = ptr;
    } else {
      res2 = SWIG_ConvertPtrAndOwn(obj1, &argp2, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t,  0 , &newmem);
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_GosatNoiseModel" "', argument " "2"" of type '" "FullPhysics::AcosSoundingId const &""'"); 
      }
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_GosatNoiseModel" "', argument " "2"" of type '" "FullPhysics::AcosSoundingId const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::AcosSoundingId > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const FullPhysics::AcosSoundingId > * >(argp2);
        arg2 = const_cast< FullPhysics::AcosSoundingId * >(tempshared2.get());
      } else {
        arg2 = const_cast< FullPhysics::AcosSoundingId * >(reinterpret_cast< boost::shared_ptr< const FullPhysics::AcosSoundingId > * >(argp2)->get());
      }
    }
  }
  {
    ...
    res3 = SWIG_ConvertPtrAndOwn(obj2, (void**)(&ptr), SWIGTYPE_p_FullPhysics__Instrument,  0 , &newmem);
    if (SWIG_IsOK(res3)) {
      arg3 = ptr;
    } else {
      res3 = SWIG_ConvertPtrAndOwn(obj2, &argp3, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Instrument_t,  0 , &newmem);
      if (!SWIG_IsOK(res3)) {
        SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "new_GosatNoiseModel" "', argument " "3"" of type '" "FullPhysics::Instrument const &""'"); 
      }
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_GosatNoiseModel" "', argument " "3"" of type '" "FullPhysics::Instrument const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared3 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::Instrument > * >(argp3);
        delete reinterpret_cast< boost::shared_ptr< const FullPhysics::Instrument > * >(argp3);
        arg3 = const_cast< FullPhysics::Instrument * >(tempshared3.get());
      } else {
        arg3 = const_cast< FullPhysics::Instrument * >(reinterpret_cast< boost::shared_ptr< const FullPhysics::Instrument > * >(argp3)->get());
      }
    }
  }
  {
    try {
      result = (FullPhysics::GosatNoiseModel *)new FullPhysics::GosatNoiseModel((FullPhysics::HdfFile const &)*arg1,(FullPhysics::AcosSoundingId const &)*arg2,(FullPhysics::Instrument const &)*arg3);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_new_GosatNoiseModel__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::HdfFile *arg1 = 0 ;
  FullPhysics::AcosSoundingId *arg2 = 0 ;
  FullPhysics::Instrument *arg3 = 0 ;
  FullPhysics::HeritageFile *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::HdfFile const > tempshared1 ;
  void *argp2 = 0 ;
  ...
  void *argp4 = 0 ;
  int res4 = 0 ;
  boost::shared_ptr< FullPhysics::HeritageFile const > tempshared4 ;
  PyObject * obj0 = 0 ;
  PyObject * obj1 = 0 ;
  PyObject * obj2 = 0 ;
  PyObject * obj3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:new_GosatNoiseModel",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
    // First check to see if all ready pointer type
  ...
  }
  {
    ...
    // First check to see if all ready pointer type
    FullPhysics::HeritageFile *ptr;
    res4 = SWIG_ConvertPtrAndOwn(obj3, (void**)(&ptr), SWIGTYPE_p_FullPhysics__HeritageFile,  0 , &newmem);
    if (SWIG_IsOK(res4)) {
      arg4 = ptr;
    } else {
      res4 = SWIG_ConvertPtrAndOwn(obj3, &argp4, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t,  0 , &newmem);
      if (!SWIG_IsOK(res4)) {
        SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "new_GosatNoiseModel" "', argument " "4"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (!argp4) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_GosatNoiseModel" "', argument " "4"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared4 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp4);
        delete reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp4);
        arg4 = const_cast< FullPhysics::HeritageFile * >(tempshared4.get());
      } else {
        arg4 = const_cast< FullPhysics::HeritageFile * >(reinterpret_cast< boost::shared_ptr< const FullPhysics::HeritageFile > * >(argp4)->get());
      }
    }
  }
  {
    try {
      result = (FullPhysics::GosatNoiseModel *)new FullPhysics::GosatNoiseModel((FullPhysics::HdfFile const &)*arg1,(FullPhysics::AcosSoundingId const &)*arg2,(FullPhysics::Instrument const &)*arg3,(FullPhysics::HeritageFile const &)*arg4);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_new_GosatNoiseModel(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[5] = {
    0
  };
  ...
  if (argc == 1) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_GosatNoiseModel__SWIG_0(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      int res = SWIG_ConvertPtr(argv[1], 0, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_GosatNoiseModel__SWIG_1(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      int res = SWIG_ConvertPtr(argv[1], 0, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
        int res = SWIG_ConvertPtr(argv[2], 0, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Instrument_t, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_new_GosatNoiseModel__SWIG_2(self, args);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          int res = SWIG_ConvertPtr(argv[3], 0, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t, 0);
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_new_GosatNoiseModel__SWIG_3(self, args);
          }
        }
      }
    }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_GosatNoiseModel'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    FullPhysics::GosatNoiseModel::GosatNoiseModel(FullPhysics::HeritageFile const &)\n"
    "    FullPhysics::GosatNoiseModel::GosatNoiseModel(FullPhysics::HeritageFile const &,FullPhysics::HeritageFile const &)\n"
    "    FullPhysics::GosatNoiseModel::GosatNoiseModel(FullPhysics::HdfFile const &,FullPhysics::AcosSoundingId const &,FullPhysics::Instrument const &)\n"
    "    FullPhysics::GosatNoiseModel::GosatNoiseModel(FullPhysics::HdfFile const &,FullPhysics::AcosSoundingId const &,FullPhysics::Instrument const &,FullPhysics::HeritageFile const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_GosatNoiseModel_uncertainty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::GosatNoiseModel *arg1 = (FullPhysics::GosatNoiseModel *) 0 ;
  int arg2 ;
  blitz::Array< double,1 > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::GosatNoiseModel const > tempshared1 ;
  boost::shared_ptr< FullPhysics::GosatNoiseModel const > *smartarg1 = 0 ;
  int val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:GosatNoiseModel_uncertainty",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "GosatNoiseModel_uncertainty" "', argument " "1"" of type '" "FullPhysics::GosatNoiseModel const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::GosatNoiseModel > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::GosatNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::GosatNoiseModel * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::GosatNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::GosatNoiseModel * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "GosatNoiseModel_uncertainty" "', argument " "2"" of type '" "int""'");
  } 
  ...
  {
    try {
      result = ((FullPhysics::GosatNoiseModel const *)arg1)->uncertainty(arg2,(blitz::Array< double,1 > const &)*arg3);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_GosatNoiseModel(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::GosatNoiseModel *arg1 = (FullPhysics::GosatNoiseModel *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::GosatNoiseModel > tempshared1 ;
  boost::shared_ptr< FullPhysics::GosatNoiseModel > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_GosatNoiseModel",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_GosatNoiseModel" "', argument " "1"" of type '" "FullPhysics::GosatNoiseModel *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::GosatNoiseModel > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::GosatNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::GosatNoiseModel * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::GosatNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::GosatNoiseModel * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *GosatNoiseModel_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::AcosSoundingId > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__NoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::NoiseModel > *)x);
}
static void *_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::GosatNoiseModel > *)x);
}
...
static void *_p_FullPhysics__AcosSoundingIdTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::HdfSoundingId *) ((FullPhysics::AcosSoundingId *) x));
}
...
static void *_p_FullPhysics__NoiseModelTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *)  ((FullPhysics::NoiseModel *) x));
}
static void *_p_FullPhysics__GosatNoiseModelTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::NoiseModel *) ((FullPhysics::GosatNoiseModel *) x));
}
...
static void *_p_FullPhysics__AcosSoundingIdTo_p_FullPhysics__HdfSoundingId(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::HdfSoundingId *)  ((FullPhysics::AcosSoundingId *) x));
}
...
static void *_p_FullPhysics__GosatNoiseModelTo_p_FullPhysics__NoiseModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::NoiseModel *)  ((FullPhysics::GosatNoiseModel *) x));
}
static void *_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__NoiseModel_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::NoiseModel >(*(boost::shared_ptr< FullPhysics::GosatNoiseModel > *)x);
}
static void *_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_tTo_p_boost__shared_ptrT_FullPhysics__HdfSoundingId_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::HdfSoundingId >(*(boost::shared_ptr< FullPhysics::AcosSoundingId > *)x);
}
...
static swig_type_info _swigt__p_FullPhysics__AcosSoundingId = {"_p_FullPhysics__AcosSoundingId", "FullPhysics::AcosSoundingId *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_FullPhysics__GosatNoiseModel = {"_p_FullPhysics__GosatNoiseModel", "FullPhysics::GosatNoiseModel *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_FullPhysics__NoiseModel = {"_p_FullPhysics__NoiseModel", "FullPhysics::NoiseModel *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t = {"_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t", "boost::shared_ptr< FullPhysics::AcosSoundingId > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t = {"_p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t", "boost::shared_ptr< FullPhysics::GosatNoiseModel > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__NoiseModel_t = {"_p_boost__shared_ptrT_FullPhysics__NoiseModel_t", "boost::shared_ptr< FullPhysics::NoiseModel > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FullPhysics__AcosSoundingId,
  ...
  &_swigt__p_FullPhysics__GosatNoiseModel,
  ...
  &_swigt__p_FullPhysics__NoiseModel,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__NoiseModel_t,
...
static swig_cast_info _swigc__p_FullPhysics__AcosSoundingId[] = {  {&_swigt__p_FullPhysics__AcosSoundingId, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_FullPhysics__NoiseModel[] = {  {&_swigt__p_FullPhysics__NoiseModel, 0, 0, 0},  {&_swigt__p_FullPhysics__GosatNoiseModel, _p_FullPhysics__GosatNoiseModelTo_p_FullPhysics__NoiseModel, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__HdfSoundingId_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__HdfSoundingId_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t, _p_boost__shared_ptrT_FullPhysics__AcosSoundingId_tTo_p_boost__shared_ptrT_FullPhysics__HdfSoundingId_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__NoiseModel_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t, _p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__NoiseModel_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__NoiseModel_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FullPhysics__AcosSoundingId,
  ...
  _swigc__p_FullPhysics__GosatNoiseModel,
  ...
  _swigc__p_FullPhysics__NoiseModel,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__GosatNoiseModel_t,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__NoiseModel_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::GosatNoiseModel))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::GosatNoiseModel >("boost::shared_ptr< FullPhysics::GosatNoiseModel > *"));
