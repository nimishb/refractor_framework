...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_fluorescence_effect_output', [dirname(__file__)])
        except ImportError:
            import _fluorescence_effect_output
            return _fluorescence_effect_output
        if fp is not None:
            try:
                _mod = imp.load_module('_fluorescence_effect_output', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _fluorescence_effect_output = swig_import_helper()
...
_fluorescence_effect_output.SHARED_PTR_DISOWN_swigconstant(_fluorescence_effect_output)
SHARED_PTR_DISOWN = _fluorescence_effect_output.SHARED_PTR_DISOWN
...
class FluorescenceEffectOutput(full_physics_swig.register_output_base.RegisterOutputBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, FluorescenceEffectOutput, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.register_output_base.RegisterOutputBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, FluorescenceEffectOutput, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _fluorescence_effect_output.delete_FluorescenceEffectOutput
