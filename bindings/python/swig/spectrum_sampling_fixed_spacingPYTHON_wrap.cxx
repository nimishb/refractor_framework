...
#define SWIGTYPE_p_FullPhysics__SpectralRange swig_types[8]
#define SWIGTYPE_p_FullPhysics__Spectrum swig_types[9]
#define SWIGTYPE_p_FullPhysics__SpectrumSampling swig_types[10]
#define SWIGTYPE_p_FullPhysics__SpectrumSamplingFixedSpacing swig_types[11]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralDomain_t swig_types[33]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralRange_t swig_types[34]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t swig_types[35]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t swig_types[36]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Spectrum_t swig_types[37]
...
/*-----------------------------------------------
              @(target):= _spectrum_sampling_fixed_spacing.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__spectrum_sampling_fixed_spacing

#else
#  define SWIG_init    init_spectrum_sampling_fixed_spacing

#endif
#define SWIG_name    "_spectrum_sampling_fixed_spacing"
...
#include "spectrum_sampling_fixed_spacingPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_SpectrumSamplingFixedSpacing(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  PyObject * obj0 = 0 ;
  FullPhysics::SpectrumSamplingFixedSpacing *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_SpectrumSamplingFixedSpacing",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_SpectrumSamplingFixedSpacing" "', argument " "1"" of type '" "FullPhysics::ArrayWithUnit< double,1 > const &""'"); 
      }
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_SpectrumSamplingFixedSpacing" "', argument " "1"" of type '" "FullPhysics::ArrayWithUnit< double,1 > const &""'"); 
      }
  ...
  {
    try {
      result = (FullPhysics::SpectrumSamplingFixedSpacing *)new FullPhysics::SpectrumSamplingFixedSpacing((FullPhysics::ArrayWithUnit< double,1 > const &)*arg1);
  ...
  {
    boost::shared_ptr<  FullPhysics::SpectrumSamplingFixedSpacing > *smartresult = result ? new boost::shared_ptr<  FullPhysics::SpectrumSamplingFixedSpacing >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_SpectrumSamplingFixedSpacing_spectral_domain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::SpectrumSamplingFixedSpacing *arg1 = (FullPhysics::SpectrumSamplingFixedSpacing *) 0 ;
  int arg2 ;
  FullPhysics::SpectralDomain *arg3 = 0 ;
  FullPhysics::DoubleWithUnit *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing const > tempshared1 ;
  boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing const > *smartarg1 = 0 ;
  int val2 ;
  int ecode2 = 0 ;
  void *argp3 = 0 ;
  int res3 = 0 ;
  boost::shared_ptr< FullPhysics::SpectralDomain const > tempshared3 ;
  void *argp4 = 0 ;
  int res4 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:SpectrumSamplingFixedSpacing_spectral_domain",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SpectrumSamplingFixedSpacing_spectral_domain" "', argument " "1"" of type '" "FullPhysics::SpectrumSamplingFixedSpacing const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::SpectrumSamplingFixedSpacing > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::SpectrumSamplingFixedSpacing > * >(argp1);
      arg1 = const_cast< FullPhysics::SpectrumSamplingFixedSpacing * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::SpectrumSamplingFixedSpacing > * >(argp1);
      arg1 = const_cast< FullPhysics::SpectrumSamplingFixedSpacing * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "SpectrumSamplingFixedSpacing_spectral_domain" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    ...
    res3 = SWIG_ConvertPtrAndOwn(obj2, (void**)(&ptr), SWIGTYPE_p_FullPhysics__SpectralDomain,  0 , &newmem);
    if (SWIG_IsOK(res3)) {
      arg3 = ptr;
    } else {
      res3 = SWIG_ConvertPtrAndOwn(obj2, &argp3, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralDomain_t,  0 , &newmem);
      if (!SWIG_IsOK(res3)) {
        SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "SpectrumSamplingFixedSpacing_spectral_domain" "', argument " "3"" of type '" "FullPhysics::SpectralDomain const &""'"); 
      }
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "SpectrumSamplingFixedSpacing_spectral_domain" "', argument " "3"" of type '" "FullPhysics::SpectralDomain const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared3 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::SpectralDomain > * >(argp3);
        delete reinterpret_cast< boost::shared_ptr< const FullPhysics::SpectralDomain > * >(argp3);
        arg3 = const_cast< FullPhysics::SpectralDomain * >(tempshared3.get());
      } else {
        arg3 = const_cast< FullPhysics::SpectralDomain * >(reinterpret_cast< boost::shared_ptr< const FullPhysics::SpectralDomain > * >(argp3)->get());
      }
    }
  }
  {
    ...
    if (SWIG_IsOK(res4)) {
      ...
      if (!SWIG_IsOK(res4)) {
        SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "SpectrumSamplingFixedSpacing_spectral_domain" "', argument " "4"" of type '" "FullPhysics::DoubleWithUnit const &""'"); 
      }
      if (!argp4) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "SpectrumSamplingFixedSpacing_spectral_domain" "', argument " "4"" of type '" "FullPhysics::DoubleWithUnit const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = ((FullPhysics::SpectrumSamplingFixedSpacing const *)arg1)->spectral_domain(arg2,(FullPhysics::SpectralDomain const &)*arg3,(FullPhysics::DoubleWithUnit const &)*arg4);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_SpectrumSamplingFixedSpacing(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::SpectrumSamplingFixedSpacing *arg1 = (FullPhysics::SpectrumSamplingFixedSpacing *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing > tempshared1 ;
  boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_SpectrumSamplingFixedSpacing",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_SpectrumSamplingFixedSpacing" "', argument " "1"" of type '" "FullPhysics::SpectrumSamplingFixedSpacing *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::SpectrumSamplingFixedSpacing > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::SpectrumSamplingFixedSpacing > * >(argp1);
      arg1 = const_cast< FullPhysics::SpectrumSamplingFixedSpacing * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::SpectrumSamplingFixedSpacing > * >(argp1);
      arg1 = const_cast< FullPhysics::SpectrumSamplingFixedSpacing * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *SpectrumSamplingFixedSpacing_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_FullPhysics__SpectrumSamplingFixedSpacingTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::SpectrumSampling *) ((FullPhysics::SpectrumSamplingFixedSpacing *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing > *)x);
}
...
static void *_p_FullPhysics__SpectrumSamplingFixedSpacingTo_p_FullPhysics__SpectrumSampling(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::SpectrumSampling *)  ((FullPhysics::SpectrumSamplingFixedSpacing *) x));
}
static void *_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_tTo_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::SpectrumSampling >(*(boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing > *)x);
}
...
static swig_type_info _swigt__p_FullPhysics__SpectrumSamplingFixedSpacing = {"_p_FullPhysics__SpectrumSamplingFixedSpacing", "FullPhysics::SpectrumSamplingFixedSpacing *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t = {"_p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t", "boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__SpectrumSamplingFixedSpacing,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t,
...
static swig_cast_info _swigc__p_FullPhysics__SpectrumSampling[] = {  {&_swigt__p_FullPhysics__SpectrumSampling, 0, 0, 0},  {&_swigt__p_FullPhysics__SpectrumSamplingFixedSpacing, _p_FullPhysics__SpectrumSamplingFixedSpacingTo_p_FullPhysics__SpectrumSampling, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__SpectrumSamplingFixedSpacing[] = {  {&_swigt__p_FullPhysics__SpectrumSamplingFixedSpacing, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t, _p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_tTo_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__SpectrumSamplingFixedSpacing,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__SpectrumSamplingFixedSpacing_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::SpectrumSamplingFixedSpacing))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::SpectrumSamplingFixedSpacing >("boost::shared_ptr< FullPhysics::SpectrumSamplingFixedSpacing > *"));
