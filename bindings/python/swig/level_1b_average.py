...
_level_1b_average.SHARED_PTR_DISOWN_swigconstant(_level_1b_average)
...
class Level1bAverage(full_physics_swig.level_1b.Level1b):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, Level1bAverage, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.level_1b.Level1b]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, Level1bAverage, name)
