...
class TemperatureFixedLevel(full_physics_swig.temperature_imp_base.TemperatureImpBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, TemperatureFixedLevel, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.temperature_imp_base.TemperatureImpBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TemperatureFixedLevel, name)
    __repr__ = _swig_repr
