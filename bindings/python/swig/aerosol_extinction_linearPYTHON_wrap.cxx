...
#define SWIGTYPE_p_FullPhysics__AerosolExtinctionLinear swig_types[2]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t swig_types[33]
...
/*-----------------------------------------------
              @(target):= _aerosol_extinction_linear.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__aerosol_extinction_linear

#else
#  define SWIG_init    init_aerosol_extinction_linear

#endif
#define SWIG_name    "_aerosol_extinction_linear"
...
#include "aerosol_extinction_linearPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_AerosolExtinctionLinear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  PyObject * obj2 = 0 ;
  PyObject * obj3 = 0 ;
  FullPhysics::AerosolExtinctionLinear *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"OOOO:new_AerosolExtinctionLinear",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Pressure_t,  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_AerosolExtinctionLinear" "', argument " "1"" of type '" "boost::shared_ptr< FullPhysics::Pressure > const &""'"); 
    }
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "new_AerosolExtinctionLinear" "', argument " "4"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_AerosolExtinctionLinear" "', argument " "4"" of type '" "std::string const &""'"); 
    }
    arg4 = ptr;
  }
  {
    try {
      result = (FullPhysics::AerosolExtinctionLinear *)new FullPhysics::AerosolExtinctionLinear((boost::shared_ptr< FullPhysics::Pressure > const &)*arg1,(blitz::Array< bool,1 > const &)*arg2,(blitz::Array< double,1 > const &)*arg3,(std::string const &)*arg4);
  ...
  {
    boost::shared_ptr<  FullPhysics::AerosolExtinctionLinear > *smartresult = result ? new boost::shared_ptr<  FullPhysics::AerosolExtinctionLinear >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
...
SWIGINTERN PyObject *_wrap_AerosolExtinctionLinear_clone__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::AerosolExtinctionLinear *arg1 = (FullPhysics::AerosolExtinctionLinear *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::AerosolExtinctionLinear const > tempshared1 ;
  boost::shared_ptr< FullPhysics::AerosolExtinctionLinear const > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  boost::shared_ptr< FullPhysics::AerosolExtinction > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:AerosolExtinctionLinear_clone",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AerosolExtinctionLinear_clone" "', argument " "1"" of type '" "FullPhysics::AerosolExtinctionLinear const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::AerosolExtinctionLinear > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::AerosolExtinctionLinear > * >(argp1);
      arg1 = const_cast< FullPhysics::AerosolExtinctionLinear * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::AerosolExtinctionLinear > * >(argp1);
      arg1 = const_cast< FullPhysics::AerosolExtinctionLinear * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
      result = ((FullPhysics::AerosolExtinctionLinear const *)arg1)->clone();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_AerosolExtinctionLinear_clone__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::AerosolExtinctionLinear *arg1 = (FullPhysics::AerosolExtinctionLinear *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:AerosolExtinctionLinear_clone",&obj0,&obj1)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "AerosolExtinctionLinear_clone" "', argument " "2"" of type '" "boost::shared_ptr< FullPhysics::Pressure > const &""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = ((FullPhysics::AerosolExtinctionLinear const *)arg1)->clone((boost::shared_ptr< FullPhysics::Pressure > const &)*arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_AerosolExtinctionLinear_clone(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  ...
  if (argc == 1) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_AerosolExtinctionLinear_clone__SWIG_0(self, args);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_AerosolExtinctionLinear_clone__SWIG_1(self, args);
      }
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'AerosolExtinctionLinear_clone'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    FullPhysics::AerosolExtinctionLinear::clone() const\n"
    "    FullPhysics::AerosolExtinctionLinear::clone(boost::shared_ptr< FullPhysics::Pressure > const &) const\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_AerosolExtinctionLinear_state_vector_name_i(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::AerosolExtinctionLinear *arg1 = (FullPhysics::AerosolExtinctionLinear *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:AerosolExtinctionLinear_state_vector_name_i",&obj0,&obj1)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AerosolExtinctionLinear_state_vector_name_i" "', argument " "1"" of type '" "FullPhysics::AerosolExtinctionLinear const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::AerosolExtinctionLinear > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::AerosolExtinctionLinear > * >(argp1);
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "AerosolExtinctionLinear_state_vector_name_i" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    try {
      result = ((FullPhysics::AerosolExtinctionLinear const *)arg1)->state_vector_name_i(arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_AerosolExtinctionLinear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::AerosolExtinctionLinear *arg1 = (FullPhysics::AerosolExtinctionLinear *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > tempshared1 ;
  boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_AerosolExtinctionLinear",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_AerosolExtinctionLinear" "', argument " "1"" of type '" "FullPhysics::AerosolExtinctionLinear *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::AerosolExtinctionLinear > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::AerosolExtinctionLinear > * >(argp1);
      arg1 = const_cast< FullPhysics::AerosolExtinctionLinear * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::AerosolExtinctionLinear > * >(argp1);
      arg1 = const_cast< FullPhysics::AerosolExtinctionLinear * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *AerosolExtinctionLinear_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__AerosolExtinction_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::AerosolExtinction >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionImpBase_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::AerosolExtinctionImpBase >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__SubStateVectorObserver_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::SubStateVectorObserver >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__ObserverT_FullPhysics__StateVector_t(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::Observer< FullPhysics::StateVector > *) (FullPhysics::StateVectorObserver *)(FullPhysics::AerosolExtinction *)(FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__StateVectorObserver_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::StateVectorObserver >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__SubStateVectorArrayT_FullPhysics__AerosolExtinction_t_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__AerosolExtinctionImpBase(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::AerosolExtinctionImpBase *)  ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__StateVectorObserver(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::StateVectorObserver *) (FullPhysics::AerosolExtinction *)(FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__SubStateVectorObserver(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::SubStateVectorObserver *) (FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::Observable< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinction *)(FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__ObserverT_FullPhysics__StateVector_t_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::Observer< FullPhysics::StateVector > >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__ObservableT_FullPhysics__AerosolExtinction_t_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::Observable< FullPhysics::AerosolExtinction > >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__SubStateVectorArrayT_FullPhysics__AerosolExtinction_t(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *) (FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *)x);
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__AerosolExtinction(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::AerosolExtinction *) (FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static void *_p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__ObservableT_FullPhysics__AerosolExtinction_t(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::Observable< FullPhysics::AerosolExtinction > *) (FullPhysics::AerosolExtinction *)(FullPhysics::SubStateVectorArray< FullPhysics::AerosolExtinction > *)(FullPhysics::AerosolExtinctionImpBase *) ((FullPhysics::AerosolExtinctionLinear *) x));
}
...
static swig_type_info _swigt__p_FullPhysics__AerosolExtinctionLinear = {"_p_FullPhysics__AerosolExtinctionLinear", "FullPhysics::AerosolExtinctionLinear *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t = {"_p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t", "boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__AerosolExtinctionLinear,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t,
...
static swig_cast_info _swigc__p_FullPhysics__AerosolExtinction[] = {  {&_swigt__p_FullPhysics__AerosolExtinctionImpBase, _p_FullPhysics__AerosolExtinctionImpBaseTo_p_FullPhysics__AerosolExtinction, 0, 0},  {&_swigt__p_FullPhysics__AerosolExtinction, 0, 0, 0},  {&_swigt__p_FullPhysics__SubStateVectorArrayT_FullPhysics__AerosolExtinction_t, _p_FullPhysics__SubStateVectorArrayT_FullPhysics__AerosolExtinction_tTo_p_FullPhysics__AerosolExtinction, 0, 0},  {&_swigt__p_FullPhysics__AerosolExtinctionLinear, _p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__AerosolExtinction, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__AerosolExtinctionImpBase[] = {  {&_swigt__p_FullPhysics__AerosolExtinctionImpBase, 0, 0, 0},  {&_swigt__p_FullPhysics__AerosolExtinctionLinear, _p_FullPhysics__AerosolExtinctionLinearTo_p_FullPhysics__AerosolExtinctionImpBase, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__AerosolExtinctionLinear[] = {  {&_swigt__p_FullPhysics__AerosolExtinctionLinear, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__AerosolExtinctionLinear,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__AerosolExtinctionLinear_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::AerosolExtinctionLinear))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::AerosolExtinctionLinear >("boost::shared_ptr< FullPhysics::AerosolExtinctionLinear > *"));
