...
#define SWIGTYPE_p_FullPhysics__MaxLikelihood swig_types[7]
#define SWIGTYPE_p_FullPhysics__MaxLikelihoodOCO swig_types[8]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t swig_types[42]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihood_t swig_types[43]
...
/*-----------------------------------------------
              @(target):= _max_likelihood_oco.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__max_likelihood_oco

#else
#  define SWIG_init    init_max_likelihood_oco

#endif
#define SWIG_name    "_max_likelihood_oco"
...
#include "max_likelihood_ocoPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_MaxLikelihoodOCO(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  PyObject * obj0 = 0 ;
  FullPhysics::MaxLikelihoodOCO *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_MaxLikelihoodOCO",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModel_t,  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_MaxLikelihoodOCO" "', argument " "1"" of type '" "boost::shared_ptr< FullPhysics::ForwardModel > const &""'"); 
    }
  ...
  {
    try {
      result = (FullPhysics::MaxLikelihoodOCO *)new FullPhysics::MaxLikelihoodOCO((boost::shared_ptr< FullPhysics::ForwardModel > const &)*arg1);
  ...
  {
    boost::shared_ptr<  FullPhysics::MaxLikelihoodOCO > *smartresult = result ? new boost::shared_ptr<  FullPhysics::MaxLikelihoodOCO >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_MaxLikelihoodOCO(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::MaxLikelihoodOCO *arg1 = (FullPhysics::MaxLikelihoodOCO *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > tempshared1 ;
  boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_MaxLikelihoodOCO",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_MaxLikelihoodOCO" "', argument " "1"" of type '" "FullPhysics::MaxLikelihoodOCO *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::MaxLikelihoodOCO > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::MaxLikelihoodOCO > * >(argp1);
      arg1 = const_cast< FullPhysics::MaxLikelihoodOCO * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::MaxLikelihoodOCO > * >(argp1);
      arg1 = const_cast< FullPhysics::MaxLikelihoodOCO * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
...
SWIGINTERN PyObject *MaxLikelihoodOCO_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_tTo_p_boost__shared_ptrT_FullPhysics__ModelMeasureOCO_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::ModelMeasureOCO >(*(boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *)x);
}
...
static void *_p_FullPhysics__MaxLikelihoodOCOTo_p_FullPhysics__MaxLikelihood(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::MaxLikelihood *)  ((FullPhysics::MaxLikelihoodOCO *) x));
}
...
static void *_p_FullPhysics__MaxLikelihoodOCOTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::ProblemState *)(FullPhysics::ModelState *)(FullPhysics::ModelMeasure *)(FullPhysics::MaxLikelihood *) ((FullPhysics::MaxLikelihoodOCO *) x));
}
...
static void *_p_FullPhysics__MaxLikelihoodOCOTo_p_FullPhysics__ProblemState(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::ProblemState *) (FullPhysics::ModelState *)(FullPhysics::ModelMeasure *)(FullPhysics::MaxLikelihood *) ((FullPhysics::MaxLikelihoodOCO *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_tTo_p_boost__shared_ptrT_FullPhysics__MaxLikelihood_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::MaxLikelihood >(*(boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *)x);
}
static void *_p_FullPhysics__MaxLikelihoodOCOTo_p_FullPhysics__ModelMeasure(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::ModelMeasure *) (FullPhysics::MaxLikelihood *) ((FullPhysics::MaxLikelihoodOCO *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_tTo_p_boost__shared_ptrT_FullPhysics__ModelState_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::ModelState >(*(boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_tTo_p_boost__shared_ptrT_FullPhysics__ProblemState_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::ProblemState >(*(boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_tTo_p_boost__shared_ptrT_FullPhysics__ModelMeasure_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::ModelMeasure >(*(boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *)x);
}
...
static void *_p_FullPhysics__MaxLikelihoodOCOTo_p_FullPhysics__ModelState(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::ModelState *) (FullPhysics::ModelMeasure *)(FullPhysics::MaxLikelihood *) ((FullPhysics::MaxLikelihoodOCO *) x));
}
...
static void *_p_FullPhysics__MaxLikelihoodOCOTo_p_FullPhysics__ModelMeasureOCO(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::ModelMeasureOCO *)  ((FullPhysics::MaxLikelihoodOCO *) x));
}
...
static swig_type_info _swigt__p_FullPhysics__MaxLikelihoodOCO = {"_p_FullPhysics__MaxLikelihoodOCO", "FullPhysics::MaxLikelihoodOCO *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t = {"_p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t", "boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__MaxLikelihoodOCO,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t,
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__MaxLikelihoodOCO,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__MaxLikelihoodOCO_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::MaxLikelihoodOCO))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::MaxLikelihoodOCO >("boost::shared_ptr< FullPhysics::MaxLikelihoodOCO > *"));
