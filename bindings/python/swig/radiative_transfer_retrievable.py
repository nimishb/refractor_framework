...
class ObservableRadiativeTransferRetrievable(full_physics_swig.generic_object.GenericObject):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, ObservableRadiativeTransferRetrievable, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ObservableRadiativeTransferRetrievable, name)
    ...
    def add_observer_and_keep_reference(self, Obs):
        return _radiative_transfer_retrievable.ObservableRadiativeTransferRetrievable_add_observer_and_keep_reference(self, Obs)

    def add_observer(self, Obs):
        return _radiative_transfer_retrievable.ObservableRadiativeTransferRetrievable_add_observer(self, Obs)

    def remove_observer(self, Obs):
        return _radiative_transfer_retrievable.ObservableRadiativeTransferRetrievable_remove_observer(self, Obs)
...
class ObserverRadiativeTransferRetrievable(full_physics_swig.generic_object.GenericObject):
    ...
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ObserverRadiativeTransferRetrievable, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ObserverRadiativeTransferRetrievable, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _radiative_transfer_retrievable.new_ObserverRadiativeTransferRetrievable()
        try:
    ...
    def notify_update(self, Observed_object):
        return _radiative_transfer_retrievable.ObserverRadiativeTransferRetrievable_notify_update(self, Observed_object)

    def notify_add(self, Observed_object):
        return _radiative_transfer_retrievable.ObserverRadiativeTransferRetrievable_notify_add(self, Observed_object)

    def notify_remove(self, Observed_object):
        return _radiative_transfer_retrievable.ObserverRadiativeTransferRetrievable_notify_remove(self, Observed_object)
...
class RadiativeTransferRetrievable(full_physics_swig.radiative_transfer.RadiativeTransfer, full_physics_swig.state_vector.StateVectorObserver, ObservableRadiativeTransferRetrievable):
    ...
    for _s in [full_physics_swig.radiative_transfer.RadiativeTransfer, full_physics_swig.state_vector.StateVectorObserver, ObservableRadiativeTransferRetrievable]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, RadiativeTransferRetrievable, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.radiative_transfer.RadiativeTransfer, full_physics_swig.state_vector.StateVectorObserver, ObservableRadiativeTransferRetrievable]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, RadiativeTransferRetrievable, name)
...
class SubStateVectorArrayRadiativeTransfer(RadiativeTransferRetrievable, full_physics_swig.state_vector.SubStateVectorObserver):
    __swig_setmethods__ = {}
    for _s in [RadiativeTransferRetrievable, full_physics_swig.state_vector.SubStateVectorObserver]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SubStateVectorArrayRadiativeTransfer, name, value)
    __swig_getmethods__ = {}
    for _s in [RadiativeTransferRetrievable, full_physics_swig.state_vector.SubStateVectorObserver]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SubStateVectorArrayRadiativeTransfer, name)
    ...
    def init(self, *args):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer_init(self, *args)
    __swig_destroy__ = _radiative_transfer_retrievable.delete_SubStateVectorArrayRadiativeTransfer
    __del__ = lambda self: None

    def mark_used_sub(self, Used):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer_mark_used_sub(self, Used)

    def state_vector_name_i(self, i):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer_state_vector_name_i(self, i)

    def state_vector_name_sub(self, Sv_name):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer_state_vector_name_sub(self, Sv_name)

    def update_sub_state(self, Sv_sub, Cov):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer_update_sub_state(self, Sv_sub, Cov)

    def update_sub_state_hook(self):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer_update_sub_state_hook(self)

    def _v_coefficient(self):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer__v_coefficient(self)
    ...
    def _v_used_flag_value(self):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer__v_used_flag_value(self)
    ...
    def _v_statevector_covariance(self):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer__v_statevector_covariance(self)
    ...
    def _v_pressure(self):
        return _radiative_transfer_retrievable.SubStateVectorArrayRadiativeTransfer__v_pressure(self)
