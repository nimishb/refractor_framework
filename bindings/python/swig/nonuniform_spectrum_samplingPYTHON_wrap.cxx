...
#define SWIGTYPE_p_FullPhysics__NonuniformSpectrumSampling swig_types[8]
...
#define SWIGTYPE_p_FullPhysics__SpectrumSampling swig_types[12]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t swig_types[34]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t swig_types[35]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralDomain_t swig_types[36]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralRange_t swig_types[37]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t swig_types[38]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Spectrum_t swig_types[39]
...
/*-----------------------------------------------
              @(target):= _nonuniform_spectrum_sampling.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__nonuniform_spectrum_sampling

#else
#  define SWIG_init    init_nonuniform_spectrum_sampling

#endif
#define SWIG_name    "_nonuniform_spectrum_sampling"
...
#include "nonuniform_spectrum_samplingPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_NonuniformSpectrumSampling_spectral_domain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::NonuniformSpectrumSampling *arg1 = (FullPhysics::NonuniformSpectrumSampling *) 0 ;
  int arg2 ;
  FullPhysics::SpectralDomain *arg3 = 0 ;
  FullPhysics::DoubleWithUnit *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling const > tempshared1 ;
  boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling const > *smartarg1 = 0 ;
  int val2 ;
  int ecode2 = 0 ;
  void *argp3 = 0 ;
  int res3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:NonuniformSpectrumSampling_spectral_domain",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "NonuniformSpectrumSampling_spectral_domain" "', argument " "1"" of type '" "FullPhysics::NonuniformSpectrumSampling const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::NonuniformSpectrumSampling > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::NonuniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::NonuniformSpectrumSampling * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::NonuniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::NonuniformSpectrumSampling * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "NonuniformSpectrumSampling_spectral_domain" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    ...
    if (SWIG_IsOK(res3)) {
      ...
      if (!SWIG_IsOK(res3)) {
        SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "NonuniformSpectrumSampling_spectral_domain" "', argument " "3"" of type '" "FullPhysics::SpectralDomain const &""'"); 
      }
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "NonuniformSpectrumSampling_spectral_domain" "', argument " "3"" of type '" "FullPhysics::SpectralDomain const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res4)) {
      ...
      if (!SWIG_IsOK(res4)) {
        SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "NonuniformSpectrumSampling_spectral_domain" "', argument " "4"" of type '" "FullPhysics::DoubleWithUnit const &""'"); 
      }
      if (!argp4) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "NonuniformSpectrumSampling_spectral_domain" "', argument " "4"" of type '" "FullPhysics::DoubleWithUnit const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = ((FullPhysics::NonuniformSpectrumSampling const *)arg1)->spectral_domain(arg2,(FullPhysics::SpectralDomain const &)*arg3,(FullPhysics::DoubleWithUnit const &)*arg4);
...
SWIGINTERN PyObject *_wrap_delete_NonuniformSpectrumSampling(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::NonuniformSpectrumSampling *arg1 = (FullPhysics::NonuniformSpectrumSampling *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling > tempshared1 ;
  boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_NonuniformSpectrumSampling",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_NonuniformSpectrumSampling" "', argument " "1"" of type '" "FullPhysics::NonuniformSpectrumSampling *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::NonuniformSpectrumSampling > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::NonuniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::NonuniformSpectrumSampling * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::NonuniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::NonuniformSpectrumSampling * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *NonuniformSpectrumSampling_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_FullPhysics__NonuniformSpectrumSamplingTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::SpectrumSampling *) ((FullPhysics::NonuniformSpectrumSampling *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling > *)x);
}
...
static void *_p_FullPhysics__NonuniformSpectrumSamplingTo_p_FullPhysics__SpectrumSampling(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::SpectrumSampling *)  ((FullPhysics::NonuniformSpectrumSampling *) x));
}
static void *_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_tTo_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::SpectrumSampling >(*(boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling > *)x);
}
...
static swig_type_info _swigt__p_FullPhysics__NonuniformSpectrumSampling = {"_p_FullPhysics__NonuniformSpectrumSampling", "FullPhysics::NonuniformSpectrumSampling *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t = {"_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t", "boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__NonuniformSpectrumSampling,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t,
...
static swig_cast_info _swigc__p_FullPhysics__SpectrumSampling[] = {  {&_swigt__p_FullPhysics__SpectrumSampling, 0, 0, 0},  {&_swigt__p_FullPhysics__NonuniformSpectrumSampling, _p_FullPhysics__NonuniformSpectrumSamplingTo_p_FullPhysics__SpectrumSampling, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t, _p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_tTo_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__NonuniformSpectrumSampling,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::NonuniformSpectrumSampling))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::NonuniformSpectrumSampling >("boost::shared_ptr< FullPhysics::NonuniformSpectrumSampling > *"));
