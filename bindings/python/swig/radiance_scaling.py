...
_radiance_scaling.SHARED_PTR_DISOWN_swigconstant(_radiance_scaling)
...
class RadianceScaling(full_physics_swig.instrument_correction.InstrumentCorrection):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, RadianceScaling, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.instrument_correction.InstrumentCorrection]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, RadianceScaling, name)
