...
_ground_coxmunk_plus_lambertian.SHARED_PTR_DISOWN_swigconstant(_ground_coxmunk_plus_lambertian)
...
class GroundCoxmunkPlusLambertian(full_physics_swig.ground.Ground, full_physics_swig.sub_state_vector_proxy.SubStateVectorProxy):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, GroundCoxmunkPlusLambertian, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.ground.Ground, full_physics_swig.sub_state_vector_proxy.SubStateVectorProxy]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, GroundCoxmunkPlusLambertian, name)
    __repr__ = _swig_repr
