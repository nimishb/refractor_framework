...
_lidort_rt.SHARED_PTR_DISOWN_swigconstant(_lidort_rt)
...
class LidortRt(full_physics_swig.spurr_rt.SpurrRt):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, LidortRt, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.spurr_rt.SpurrRt]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, LidortRt, name)
