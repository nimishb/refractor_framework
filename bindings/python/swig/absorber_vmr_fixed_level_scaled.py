...
_absorber_vmr_fixed_level_scaled.SHARED_PTR_DISOWN_swigconstant(_absorber_vmr_fixed_level_scaled)
...
class AbsorberVmrFixedLevelScaled(full_physics_swig.absorber_vmr_imp_base.AbsorberVmrImpBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, AbsorberVmrFixedLevelScaled, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.absorber_vmr_imp_base.AbsorberVmrImpBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, AbsorberVmrFixedLevelScaled, name)
    __repr__ = _swig_repr
