...
_cost_func.SHARED_PTR_DISOWN_swigconstant(_cost_func)
...
class CostFunc(full_physics_swig.problem_state.ProblemState):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, CostFunc, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.problem_state.ProblemState]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, CostFunc, name)
