...
_dispersion_fit_output.SHARED_PTR_DISOWN_swigconstant(_dispersion_fit_output)
...
class DispersionFitOutput(full_physics_swig.register_output_base.RegisterOutputBase):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, DispersionFitOutput, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.register_output_base.RegisterOutputBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, DispersionFitOutput, name)
