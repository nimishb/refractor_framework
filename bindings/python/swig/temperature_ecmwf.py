...
class TemperatureEcmwf(full_physics_swig.temperature_offset.TemperatureOffset):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, TemperatureEcmwf, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.temperature_offset.TemperatureOffset]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, TemperatureEcmwf, name)
    __repr__ = _swig_repr
    ...
    def _v_temperature_offset(self):
        return _temperature_ecmwf.TemperatureEcmwf__v_temperature_offset(self)
    ...
    def _v_temperature_offset_uncertainty(self):
        return _temperature_ecmwf.TemperatureEcmwf__v_temperature_offset_uncertainty(self)
