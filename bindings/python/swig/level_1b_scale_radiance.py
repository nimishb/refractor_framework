...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_level_1b_scale_radiance', [dirname(__file__)])
        except ImportError:
            import _level_1b_scale_radiance
            return _level_1b_scale_radiance
        if fp is not None:
            try:
                _mod = imp.load_module('_level_1b_scale_radiance', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _level_1b_scale_radiance = swig_import_helper()
...
_level_1b_scale_radiance.SHARED_PTR_DISOWN_swigconstant(_level_1b_scale_radiance)
SHARED_PTR_DISOWN = _level_1b_scale_radiance.SHARED_PTR_DISOWN
...
class Level1bScaleRadiance(full_physics_swig.level_1b.Level1b):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, Level1bScaleRadiance, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.level_1b.Level1b]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, Level1bScaleRadiance, name)
...
Level1bScaleRadiance_swigregister(Level1bScaleRadiance)
