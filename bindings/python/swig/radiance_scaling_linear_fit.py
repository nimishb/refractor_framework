...
_radiance_scaling_linear_fit.SHARED_PTR_DISOWN_swigconstant(_radiance_scaling_linear_fit)
...
class RadianceScalingLinearFit(full_physics_swig.radiance_scaling.RadianceScaling):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, RadianceScalingLinearFit, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.radiance_scaling.RadianceScaling]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, RadianceScalingLinearFit, name)
