...
#define SWIGTYPE_p_FullPhysics__ForwardModel swig_types[6]
#define SWIGTYPE_p_FullPhysics__ForwardModelCostFunction swig_types[7]
...
#define SWIGTYPE_p_FullPhysics__Spectrum swig_types[13]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__CostFunction_t swig_types[36]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t swig_types[37]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModel_t swig_types[38]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralDomain_t swig_types[42]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralRange_t swig_types[43]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Spectrum_t swig_types[44]
...
/*-----------------------------------------------
              @(target):= _forward_model_cost_function.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__forward_model_cost_function

#else
#  define SWIG_init    init_forward_model_cost_function

#endif
#define SWIG_name    "_forward_model_cost_function"
...
#include "forward_model_cost_functionPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_ForwardModelCostFunction(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  PyObject * obj0 = 0 ;
  FullPhysics::ForwardModelCostFunction *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_ForwardModelCostFunction",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModel_t,  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_ForwardModelCostFunction" "', argument " "1"" of type '" "boost::shared_ptr< FullPhysics::ForwardModel > const &""'"); 
    }
  ...
  {
    try {
      result = (FullPhysics::ForwardModelCostFunction *)new FullPhysics::ForwardModelCostFunction((boost::shared_ptr< FullPhysics::ForwardModel > const &)*arg1);
  ...
  {
    boost::shared_ptr<  FullPhysics::ForwardModelCostFunction > *smartresult = result ? new boost::shared_ptr<  FullPhysics::ForwardModelCostFunction >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ForwardModelCostFunction_cost_function(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::ForwardModelCostFunction *arg1 = (FullPhysics::ForwardModelCostFunction *) 0 ;
  ...
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::ForwardModelCostFunction const > tempshared1 ;
  boost::shared_ptr< FullPhysics::ForwardModelCostFunction const > *smartarg1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ForwardModelCostFunction_cost_function",&obj0,&obj1)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ForwardModelCostFunction_cost_function" "', argument " "1"" of type '" "FullPhysics::ForwardModelCostFunction const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::ForwardModelCostFunction > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::ForwardModelCostFunction > * >(argp1);
      arg1 = const_cast< FullPhysics::ForwardModelCostFunction * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::ForwardModelCostFunction > * >(argp1);
      arg1 = const_cast< FullPhysics::ForwardModelCostFunction * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
  ...
  {
    try {
      ((FullPhysics::ForwardModelCostFunction const *)arg1)->cost_function((blitz::Array< double,1 > const &)*arg2,*arg3,*arg4,*arg5);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_ForwardModelCostFunction(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::ForwardModelCostFunction *arg1 = (FullPhysics::ForwardModelCostFunction *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::ForwardModelCostFunction > tempshared1 ;
  boost::shared_ptr< FullPhysics::ForwardModelCostFunction > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ForwardModelCostFunction",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ForwardModelCostFunction" "', argument " "1"" of type '" "FullPhysics::ForwardModelCostFunction *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::ForwardModelCostFunction > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::ForwardModelCostFunction > * >(argp1);
      arg1 = const_cast< FullPhysics::ForwardModelCostFunction * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::ForwardModelCostFunction > * >(argp1);
      arg1 = const_cast< FullPhysics::ForwardModelCostFunction * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *ForwardModelCostFunction_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_FullPhysics__ForwardModelCostFunctionTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::CostFunction *) ((FullPhysics::ForwardModelCostFunction *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::ForwardModelCostFunction > *)x);
}
...
static void *_p_FullPhysics__ForwardModelCostFunctionTo_p_FullPhysics__CostFunction(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::CostFunction *)  ((FullPhysics::ForwardModelCostFunction *) x));
}
static void *_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_tTo_p_boost__shared_ptrT_FullPhysics__CostFunction_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::CostFunction >(*(boost::shared_ptr< FullPhysics::ForwardModelCostFunction > *)x);
}
...
static swig_type_info _swigt__p_FullPhysics__ForwardModelCostFunction = {"_p_FullPhysics__ForwardModelCostFunction", "FullPhysics::ForwardModelCostFunction *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t = {"_p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t", "boost::shared_ptr< FullPhysics::ForwardModelCostFunction > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__ForwardModelCostFunction,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t,
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__CostFunction_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t, _p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_tTo_p_boost__shared_ptrT_FullPhysics__CostFunction_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__CostFunction_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__ForwardModelCostFunction,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__ForwardModelCostFunction_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::ForwardModelCostFunction))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::ForwardModelCostFunction >("boost::shared_ptr< FullPhysics::ForwardModelCostFunction > *"));
