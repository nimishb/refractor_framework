...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_oco_sim_apriori', [dirname(__file__)])
        except ImportError:
            import _oco_sim_apriori
            return _oco_sim_apriori
        if fp is not None:
            try:
                _mod = imp.load_module('_oco_sim_apriori', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _oco_sim_apriori = swig_import_helper()
...
_oco_sim_apriori.SHARED_PTR_DISOWN_swigconstant(_oco_sim_apriori)
SHARED_PTR_DISOWN = _oco_sim_apriori.SHARED_PTR_DISOWN
...
class OcoSimApriori(full_physics_swig.generic_object.GenericObject):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, OcoSimApriori, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, OcoSimApriori, name)
    __repr__ = _swig_repr
    ...
    __swig_destroy__ = _oco_sim_apriori.delete_OcoSimApriori
    __del__ = lambda self: None
OcoSimApriori_swigregister = _oco_sim_apriori.OcoSimApriori_swigregister
OcoSimApriori_swigregister(OcoSimApriori)
