...
#include "oco_met_filePYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_OcoMetFile(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_OcoMetFile",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OcoMetFile_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_OcoMetFile(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:new_OcoMetFile",&obj0,&obj1)) SWIG_fail;
  {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_OcoMetFile", _wrap_delete_OcoMetFile, METH_VARARGS, (char *)"\n"
		"\n"
	 ...
	 { (char *)"new_OcoMetFile", _wrap_new_OcoMetFile, METH_VARARGS, (char *)"\n"
		"\n"
		"FullPhysics::OcoMetFile::OcoMetFile(const std::string &Fname, const boost::shared_ptr< HdfSoundingId >\n"
		"&Hdf_sounding_id)\n"
		"\n"
		""},
