...
_cost_func_diff.SHARED_PTR_DISOWN_swigconstant(_cost_func_diff)
...
class CostFuncDiff(full_physics_swig.cost_func.CostFunc):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, CostFuncDiff, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.cost_func.CostFunc]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, CostFuncDiff, name)
