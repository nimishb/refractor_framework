...
#define SWIGTYPE_p_FullPhysics__RayleighGreekMoment swig_types[0]
...
/*-----------------------------------------------
              @(target):= _rayleigh_greek_moment.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__rayleigh_greek_moment

#else
#  define SWIG_init    init_rayleigh_greek_moment

#endif
#define SWIG_name    "_rayleigh_greek_moment"
...
#include "rayleigh_greek_momentPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_RayleighGreekMoment_array(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SwigValueWrapper< blitz::Array< double,2 > > result;
  
  if (!PyArg_ParseTuple(args,(char *)":RayleighGreekMoment_array")) SWIG_fail;
  {
    try {
      result = FullPhysics::RayleighGreekMoment::array();
...
SWIGINTERN PyObject *_wrap_new_RayleighGreekMoment(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::RayleighGreekMoment *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_RayleighGreekMoment")) SWIG_fail;
  {
    try {
      result = (FullPhysics::RayleighGreekMoment *)new FullPhysics::RayleighGreekMoment();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
  ...
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_FullPhysics__RayleighGreekMoment, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_RayleighGreekMoment(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::RayleighGreekMoment *arg1 = (FullPhysics::RayleighGreekMoment *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_RayleighGreekMoment",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_FullPhysics__RayleighGreekMoment, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_RayleighGreekMoment" "', argument " "1"" of type '" "FullPhysics::RayleighGreekMoment *""'"); 
  }
  arg1 = reinterpret_cast< FullPhysics::RayleighGreekMoment * >(argp1);
  {
    try {
      delete arg1;
    } catch (Swig::DirectorException &e) {
...
SWIGINTERN PyObject *RayleighGreekMoment_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_FullPhysics__RayleighGreekMoment, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static swig_type_info _swigt__p_FullPhysics__RayleighGreekMoment = {"_p_FullPhysics__RayleighGreekMoment", "FullPhysics::RayleighGreekMoment *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_FullPhysics__RayleighGreekMoment,
...
static swig_cast_info _swigc__p_FullPhysics__RayleighGreekMoment[] = {  {&_swigt__p_FullPhysics__RayleighGreekMoment, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_FullPhysics__RayleighGreekMoment,
