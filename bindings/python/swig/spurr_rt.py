...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_spurr_rt', [dirname(__file__)])
        except ImportError:
            import _spurr_rt
            return _spurr_rt
        if fp is not None:
            try:
                _mod = imp.load_module('_spurr_rt', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _spurr_rt = swig_import_helper()
...
_spurr_rt.SHARED_PTR_DISOWN_swigconstant(_spurr_rt)
SHARED_PTR_DISOWN = _spurr_rt.SHARED_PTR_DISOWN
...
class SpurrRt(full_physics_swig.radiative_transfer_single_wn.RadiativeTransferSingleWn, full_physics_swig.rt_atmosphere.ObserverRtAtmosphere):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, SpurrRt, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.radiative_transfer_single_wn.RadiativeTransferSingleWn, full_physics_swig.rt_atmosphere.ObserverRtAtmosphere]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SpurrRt, name)
    ...
    def stokes(self, Spec_domain, Spec_index):
        return _spurr_rt.SpurrRt_stokes(self, Spec_domain, Spec_index)
