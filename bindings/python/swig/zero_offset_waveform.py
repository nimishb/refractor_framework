...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_zero_offset_waveform', [dirname(__file__)])
        except ImportError:
            import _zero_offset_waveform
            return _zero_offset_waveform
        if fp is not None:
            try:
                _mod = imp.load_module('_zero_offset_waveform', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _zero_offset_waveform = swig_import_helper()
...
_zero_offset_waveform.SHARED_PTR_DISOWN_swigconstant(_zero_offset_waveform)
SHARED_PTR_DISOWN = _zero_offset_waveform.SHARED_PTR_DISOWN
...
class ZeroOffsetWaveform(full_physics_swig.instrument_correction.SubStateVectorArrayInstrumentCorrection):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, ZeroOffsetWaveform, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.instrument_correction.SubStateVectorArrayInstrumentCorrection]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ZeroOffsetWaveform, name)
    ...
    def zero_offset(self):
        return self._v_zero_offset()

    __swig_destroy__ = _zero_offset_waveform.delete_ZeroOffsetWaveform
    __del__ = lambda self: None
ZeroOffsetWaveform_swigregister = _zero_offset_waveform.ZeroOffsetWaveform_swigregister
ZeroOffsetWaveform_swigregister(ZeroOffsetWaveform)
