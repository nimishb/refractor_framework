...
_convergence_check.SHARED_PTR_DISOWN_swigconstant(_convergence_check)
...
class FitStatistic(full_physics_swig.generic_object.GenericObject):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, FitStatistic, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, FitStatistic, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_setmethods__["fit_succeeded"] = _convergence_check.FitStatistic_fit_succeeded_set
    __swig_getmethods__["fit_succeeded"] = _convergence_check.FitStatistic_fit_succeeded_get
    if _newclass:
    ...
    __swig_setmethods__["outcome"] = _convergence_check.FitStatistic_outcome_set
    __swig_getmethods__["outcome"] = _convergence_check.FitStatistic_outcome_get
    if _newclass:
        outcome = _swig_property(_convergence_check.FitStatistic_outcome_get, _convergence_check.FitStatistic_outcome_set)
    __swig_setmethods__["number_iteration"] = _convergence_check.FitStatistic_number_iteration_set
    __swig_getmethods__["number_iteration"] = _convergence_check.FitStatistic_number_iteration_get
    if _newclass:
    ...
    __swig_setmethods__["number_divergent"] = _convergence_check.FitStatistic_number_divergent_set
    __swig_getmethods__["number_divergent"] = _convergence_check.FitStatistic_number_divergent_get
    if _newclass:
    ...
    __swig_setmethods__["d_sigma_sq"] = _convergence_check.FitStatistic_d_sigma_sq_set
    __swig_getmethods__["d_sigma_sq"] = _convergence_check.FitStatistic_d_sigma_sq_get
    if _newclass:
        d_sigma_sq = _swig_property(_convergence_check.FitStatistic_d_sigma_sq_get, _convergence_check.FitStatistic_d_sigma_sq_set)
    __swig_setmethods__["d_sigma_sq_scaled"] = _convergence_check.FitStatistic_d_sigma_sq_scaled_set
    __swig_getmethods__["d_sigma_sq_scaled"] = _convergence_check.FitStatistic_d_sigma_sq_scaled_get
    if _newclass:
    ...
    __swig_setmethods__["chisq_apriori"] = _convergence_check.FitStatistic_chisq_apriori_set
    __swig_getmethods__["chisq_apriori"] = _convergence_check.FitStatistic_chisq_apriori_get
    if _newclass:
    ...
    __swig_setmethods__["chisq_measured"] = _convergence_check.FitStatistic_chisq_measured_set
    __swig_getmethods__["chisq_measured"] = _convergence_check.FitStatistic_chisq_measured_get
    if _newclass:
    ...
    __swig_setmethods__["chisq_apriori_fc"] = _convergence_check.FitStatistic_chisq_apriori_fc_set
    __swig_getmethods__["chisq_apriori_fc"] = _convergence_check.FitStatistic_chisq_apriori_fc_get
    if _newclass:
    ...
    __swig_setmethods__["chisq_measured_fc"] = _convergence_check.FitStatistic_chisq_measured_fc_set
    __swig_getmethods__["chisq_measured_fc"] = _convergence_check.FitStatistic_chisq_measured_fc_get
    if _newclass:
...
class ConvergenceCheck(full_physics_swig.generic_object.GenericObject):
    ...
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ConvergenceCheck, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, ConvergenceCheck, name)
