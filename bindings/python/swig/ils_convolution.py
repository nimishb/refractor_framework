...
_ils_convolution.SHARED_PTR_DISOWN_swigconstant(_ils_convolution)
...
class IlsConvolution(full_physics_swig.ils.Ils, full_physics_swig.dispersion.ObserverDispersion):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, IlsConvolution, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.ils.Ils, full_physics_swig.dispersion.ObserverDispersion]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, IlsConvolution, name)
    __repr__ = _swig_repr
