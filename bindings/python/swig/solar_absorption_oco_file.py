...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_solar_absorption_oco_file', [dirname(__file__)])
        except ImportError:
            import _solar_absorption_oco_file
            return _solar_absorption_oco_file
        if fp is not None:
            try:
                _mod = imp.load_module('_solar_absorption_oco_file', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _solar_absorption_oco_file = swig_import_helper()
...
_solar_absorption_oco_file.SHARED_PTR_DISOWN_swigconstant(_solar_absorption_oco_file)
SHARED_PTR_DISOWN = _solar_absorption_oco_file.SHARED_PTR_DISOWN
...
class SolarAbsorptionOcoFile(full_physics_swig.solar_absorption_spectrum.SolarAbsorptionSpectrum):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, SolarAbsorptionOcoFile, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.solar_absorption_spectrum.SolarAbsorptionSpectrum]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SolarAbsorptionOcoFile, name)
    __repr__ = _swig_repr
    ...
    __swig_destroy__ = _solar_absorption_oco_file.delete_SolarAbsorptionOcoFile
    __del__ = lambda self: None
SolarAbsorptionOcoFile_swigregister = _solar_absorption_oco_file.SolarAbsorptionOcoFile_swigregister
SolarAbsorptionOcoFile_swigregister(SolarAbsorptionOcoFile)
