...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_level_1b_acos', [dirname(__file__)])
        except ImportError:
            import _level_1b_acos
            return _level_1b_acos
        if fp is not None:
            try:
                _mod = imp.load_module('_level_1b_acos', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _level_1b_acos = swig_import_helper()
...
_level_1b_acos.SHARED_PTR_DISOWN_swigconstant(_level_1b_acos)
SHARED_PTR_DISOWN = _level_1b_acos.SHARED_PTR_DISOWN
...
class Level1bAcos(full_physics_swig.level_1b_hdf.Level1bHdf):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(self, Level1bAcos, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.level_1b_hdf.Level1bHdf]:
...
Level1bAcos_swigregister(Level1bAcos)
