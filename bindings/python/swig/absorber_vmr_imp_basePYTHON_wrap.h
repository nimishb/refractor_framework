...
#ifndef SWIG_absorber_vmr_imp_base_WRAP_H_
#define SWIG_absorber_vmr_imp_base_WRAP_H_

#include <map>
#include <string>


class SwigDirector_AbsorberVmrImpBase : public FullPhysics::AbsorberVmrImpBase, public Swig::Director {

public:
    SwigDirector_AbsorberVmrImpBase(PyObject *self, std::string const &Gas_name, blitz::Array< double,1 > const &Coeff, blitz::Array< bool,1 > const &Used_flag, boost::shared_ptr< FullPhysics::Pressure > const &Press, bool Mark_according_to_press = true, int Pdep_start = 0);
    virtual ~SwigDirector_AbsorberVmrImpBase();
    ...
    virtual void add_observer(FullPhysics::Observer< FullPhysics::AbsorberVmr > &Obs);
    virtual void remove_observer(FullPhysics::Observer< FullPhysics::AbsorberVmr > &Obs);
    virtual boost::shared_ptr< FullPhysics::AbsorberVmr > clone() const;
    ...
    using FullPhysics::AbsorberVmrImpBase::cache_stale;
    using FullPhysics::AbsorberVmrImpBase::vmr;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class AbsorberVmrImpBase doesn't exist, undefined ";
          msg += method_name;
