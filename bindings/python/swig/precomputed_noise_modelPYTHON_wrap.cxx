...
#define SWIGTYPE_p_FullPhysics__NoiseModel swig_types[2]
#define SWIGTYPE_p_FullPhysics__PrecomputedNoiseModel swig_types[3]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HeritageFile_t swig_types[18]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NoiseModel_t swig_types[19]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t swig_types[20]
...
/*-----------------------------------------------
              @(target):= _precomputed_noise_model.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__precomputed_noise_model

#else
#  define SWIG_init    init_precomputed_noise_model

#endif
#define SWIG_name    "_precomputed_noise_model"
...
#include "precomputed_noise_modelPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_PrecomputedNoiseModel(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  PyObject * obj0 = 0 ;
  FullPhysics::PrecomputedNoiseModel *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:new_PrecomputedNoiseModel",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_PrecomputedNoiseModel" "', argument " "1"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_PrecomputedNoiseModel" "', argument " "1"" of type '" "FullPhysics::HeritageFile const &""'"); 
      }
  ...
  {
    try {
      result = (FullPhysics::PrecomputedNoiseModel *)new FullPhysics::PrecomputedNoiseModel((FullPhysics::HeritageFile const &)*arg1);
  ...
  {
    boost::shared_ptr<  FullPhysics::PrecomputedNoiseModel > *smartresult = result ? new boost::shared_ptr<  FullPhysics::PrecomputedNoiseModel >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_PrecomputedNoiseModel_uncertainty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::PrecomputedNoiseModel *arg1 = (FullPhysics::PrecomputedNoiseModel *) 0 ;
  int arg2 ;
  blitz::Array< double,1 > *arg3 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::PrecomputedNoiseModel const > tempshared1 ;
  boost::shared_ptr< FullPhysics::PrecomputedNoiseModel const > *smartarg1 = 0 ;
  int val2 ;
  int ecode2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:PrecomputedNoiseModel_uncertainty",&obj0,&obj1,&obj2)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "PrecomputedNoiseModel_uncertainty" "', argument " "1"" of type '" "FullPhysics::PrecomputedNoiseModel const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::PrecomputedNoiseModel > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::PrecomputedNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::PrecomputedNoiseModel * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::PrecomputedNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::PrecomputedNoiseModel * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "PrecomputedNoiseModel_uncertainty" "', argument " "2"" of type '" "int""'");
  } 
  ...
  {
    try {
      result = ((FullPhysics::PrecomputedNoiseModel const *)arg1)->uncertainty(arg2,(blitz::Array< double,1 > const &)*arg3);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_PrecomputedNoiseModel(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::PrecomputedNoiseModel *arg1 = (FullPhysics::PrecomputedNoiseModel *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::PrecomputedNoiseModel > tempshared1 ;
  boost::shared_ptr< FullPhysics::PrecomputedNoiseModel > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_PrecomputedNoiseModel",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_PrecomputedNoiseModel" "', argument " "1"" of type '" "FullPhysics::PrecomputedNoiseModel *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::PrecomputedNoiseModel > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::PrecomputedNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::PrecomputedNoiseModel * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::PrecomputedNoiseModel > * >(argp1);
      arg1 = const_cast< FullPhysics::PrecomputedNoiseModel * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *PrecomputedNoiseModel_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__NoiseModel_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::NoiseModel >(*(boost::shared_ptr< FullPhysics::PrecomputedNoiseModel > *)x);
}
static void *_p_FullPhysics__PrecomputedNoiseModelTo_p_FullPhysics__NoiseModel(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::NoiseModel *)  ((FullPhysics::PrecomputedNoiseModel *) x));
}
...
static void *_p_FullPhysics__PrecomputedNoiseModelTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::NoiseModel *) ((FullPhysics::PrecomputedNoiseModel *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::PrecomputedNoiseModel > *)x);
}
...
static swig_type_info _swigt__p_FullPhysics__PrecomputedNoiseModel = {"_p_FullPhysics__PrecomputedNoiseModel", "FullPhysics::PrecomputedNoiseModel *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t = {"_p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t", "boost::shared_ptr< FullPhysics::PrecomputedNoiseModel > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__PrecomputedNoiseModel,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t,
  &_swigt__p_char,
  &_swigt__p_char_type,
...
static swig_cast_info _swigc__p_FullPhysics__GenericObject[] = {  {&_swigt__p_FullPhysics__NoiseModel, _p_FullPhysics__NoiseModelTo_p_FullPhysics__GenericObject, 0, 0},  {&_swigt__p_FullPhysics__PrecomputedNoiseModel, _p_FullPhysics__PrecomputedNoiseModelTo_p_FullPhysics__GenericObject, 0, 0},  {&_swigt__p_FullPhysics__GenericObject, 0, 0, 0},  {&_swigt__p_FullPhysics__HeritageFile, _p_FullPhysics__HeritageFileTo_p_FullPhysics__GenericObject, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__HeritageFile[] = {  {&_swigt__p_FullPhysics__HeritageFile, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__NoiseModel[] = {  {&_swigt__p_FullPhysics__NoiseModel, 0, 0, 0},  {&_swigt__p_FullPhysics__PrecomputedNoiseModel, _p_FullPhysics__PrecomputedNoiseModelTo_p_FullPhysics__NoiseModel, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__PrecomputedNoiseModel[] = {  {&_swigt__p_FullPhysics__PrecomputedNoiseModel, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__GenericObject_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__HeritageFile_t, _p_boost__shared_ptrT_FullPhysics__HeritageFile_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, _p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__NoiseModel_t, _p_boost__shared_ptrT_FullPhysics__NoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__GenericObject_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__NoiseModel_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, _p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_tTo_p_boost__shared_ptrT_FullPhysics__NoiseModel_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__NoiseModel_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__PrecomputedNoiseModel,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__PrecomputedNoiseModel_t,
  _swigc__p_char,
  _swigc__p_char_type,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::PrecomputedNoiseModel))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::PrecomputedNoiseModel >("boost::shared_ptr< FullPhysics::PrecomputedNoiseModel > *"));
