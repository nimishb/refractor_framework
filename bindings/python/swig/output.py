...
_output.SHARED_PTR_DISOWN_swigconstant(_output)
...
class OutputDouble(full_physics_swig.generic_object.GenericObject):
    ...
    def __init__(self):
        if self.__class__ == OutputDouble:
            ...
            _self = self
        this = _output.new_OutputDouble(_self, )
        try:
...
class OutputBlitz1d(full_physics_swig.generic_object.GenericObject):
    ...
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, OutputBlitz1d, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, OutputBlitz1d, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        if self.__class__ == OutputBlitz1d:
            ...
            _self = self
        this = _output.new_OutputBlitz1d(_self, )
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class OutputBlitz2d(full_physics_swig.generic_object.GenericObject):
    ...
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, OutputBlitz2d, name, value)
    __swig_getmethods__ = {}
    for _s in [full_physics_swig.generic_object.GenericObject]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, OutputBlitz2d, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        if self.__class__ == OutputBlitz2d:
            ...
            _self = self
        this = _output.new_OutputBlitz2d(_self, )
        try:
            self.this.append(this)
        except Exception:
            self.this = this
