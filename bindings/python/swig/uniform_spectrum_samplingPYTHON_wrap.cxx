...
#define SWIGTYPE_p_FullPhysics__UniformSpectrumSampling swig_types[11]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t swig_types[35]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Spectrum_t swig_types[36]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t swig_types[37]
...
/*-----------------------------------------------
              @(target):= _uniform_spectrum_sampling.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__uniform_spectrum_sampling

#else
#  define SWIG_init    init_uniform_spectrum_sampling

#endif
#define SWIG_name    "_uniform_spectrum_sampling"
...
#include "uniform_spectrum_samplingPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_UniformSpectrumSampling_spectral_domain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::UniformSpectrumSampling *arg1 = (FullPhysics::UniformSpectrumSampling *) 0 ;
  int arg2 ;
  FullPhysics::SpectralDomain *arg3 = 0 ;
  FullPhysics::DoubleWithUnit *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::UniformSpectrumSampling const > tempshared1 ;
  boost::shared_ptr< FullPhysics::UniformSpectrumSampling const > *smartarg1 = 0 ;
  int val2 ;
  int ecode2 = 0 ;
  void *argp3 = 0 ;
  int res3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:UniformSpectrumSampling_spectral_domain",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "UniformSpectrumSampling_spectral_domain" "', argument " "1"" of type '" "FullPhysics::UniformSpectrumSampling const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::UniformSpectrumSampling > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::UniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::UniformSpectrumSampling * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::UniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::UniformSpectrumSampling * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "UniformSpectrumSampling_spectral_domain" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    ...
    if (SWIG_IsOK(res3)) {
      ...
      if (!SWIG_IsOK(res3)) {
        SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "UniformSpectrumSampling_spectral_domain" "', argument " "3"" of type '" "FullPhysics::SpectralDomain const &""'"); 
      }
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "UniformSpectrumSampling_spectral_domain" "', argument " "3"" of type '" "FullPhysics::SpectralDomain const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res4)) {
      ...
      if (!SWIG_IsOK(res4)) {
        SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "UniformSpectrumSampling_spectral_domain" "', argument " "4"" of type '" "FullPhysics::DoubleWithUnit const &""'"); 
      }
      if (!argp4) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "UniformSpectrumSampling_spectral_domain" "', argument " "4"" of type '" "FullPhysics::DoubleWithUnit const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = ((FullPhysics::UniformSpectrumSampling const *)arg1)->spectral_domain(arg2,(FullPhysics::SpectralDomain const &)*arg3,(FullPhysics::DoubleWithUnit const &)*arg4);
...
SWIGINTERN PyObject *_wrap_delete_UniformSpectrumSampling(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::UniformSpectrumSampling *arg1 = (FullPhysics::UniformSpectrumSampling *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::UniformSpectrumSampling > tempshared1 ;
  boost::shared_ptr< FullPhysics::UniformSpectrumSampling > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_UniformSpectrumSampling",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_UniformSpectrumSampling" "', argument " "1"" of type '" "FullPhysics::UniformSpectrumSampling *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::UniformSpectrumSampling > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::UniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::UniformSpectrumSampling * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::UniformSpectrumSampling > * >(argp1);
      arg1 = const_cast< FullPhysics::UniformSpectrumSampling * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *UniformSpectrumSampling_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_FullPhysics__UniformSpectrumSamplingTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::SpectrumSampling *) ((FullPhysics::UniformSpectrumSampling *) x));
}
...
static void *_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::UniformSpectrumSampling > *)x);
}
...
static void *_p_FullPhysics__UniformSpectrumSamplingTo_p_FullPhysics__SpectrumSampling(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::SpectrumSampling *)  ((FullPhysics::UniformSpectrumSampling *) x));
}
static void *_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_tTo_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::SpectrumSampling >(*(boost::shared_ptr< FullPhysics::UniformSpectrumSampling > *)x);
}
...
static swig_type_info _swigt__p_FullPhysics__UniformSpectrumSampling = {"_p_FullPhysics__UniformSpectrumSampling", "FullPhysics::UniformSpectrumSampling *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t = {"_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t", "boost::shared_ptr< FullPhysics::UniformSpectrumSampling > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__UniformSpectrumSampling,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t,
...
static swig_cast_info _swigc__p_FullPhysics__SpectrumSampling[] = {  {&_swigt__p_FullPhysics__SpectrumSampling, 0, 0, 0},  {&_swigt__p_FullPhysics__UniformSpectrumSampling, _p_FullPhysics__UniformSpectrumSamplingTo_p_FullPhysics__SpectrumSampling, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__UniformSpectrumSampling[] = {  {&_swigt__p_FullPhysics__UniformSpectrumSampling, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t, _p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_tTo_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__UniformSpectrumSampling,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::UniformSpectrumSampling))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::UniformSpectrumSampling >("boost::shared_ptr< FullPhysics::UniformSpectrumSampling > *"));
