...
#define SWIGTYPE_p_FullPhysics__ConnorConvergence swig_types[5]
#define SWIGTYPE_p_FullPhysics__ConnorConvergenceOutput swig_types[6]
#define SWIGTYPE_p_FullPhysics__ConvergenceCheck swig_types[7]
#define SWIGTYPE_p_FullPhysics__FitStatistic swig_types[8]
#define SWIGTYPE_p_FullPhysics__ForwardModel swig_types[9]
...
#define SWIGTYPE_p_FullPhysics__Output swig_types[13]
#define SWIGTYPE_p_FullPhysics__OutputBlitz1d swig_types[14]
#define SWIGTYPE_p_FullPhysics__OutputBlitz2d swig_types[15]
#define SWIGTYPE_p_FullPhysics__OutputDouble swig_types[16]
#define SWIGTYPE_p_FullPhysics__RegisterOutputBase swig_types[17]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t swig_types[43]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t swig_types[44]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ConvergenceCheck_t swig_types[45]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__FitStatistic_t swig_types[46]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModel_t swig_types[47]
...
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OutputBlitz1d_t swig_types[51]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OutputBlitz2d_t swig_types[52]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OutputDouble_t swig_types[53]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Output_t swig_types[54]
#define SWIGTYPE_p_boost__shared_ptrT_FullPhysics__RegisterOutputBase_t swig_types[55]
...
/*-----------------------------------------------
              @(target):= _connor_convergence_output.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__connor_convergence_output

#else
#  define SWIG_init    init_connor_convergence_output

#endif
#define SWIG_name    "_connor_convergence_output"
...
#include "connor_convergence_outputPYTHON_wrap.h"
...
SWIGINTERN PyObject *_wrap_ConnorConvergenceOutput_register_output(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::ConnorConvergenceOutput *arg1 = (FullPhysics::ConnorConvergenceOutput *) 0 ;
  boost::shared_ptr< FullPhysics::Output > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::ConnorConvergenceOutput const > tempshared1 ;
  boost::shared_ptr< FullPhysics::ConnorConvergenceOutput const > *smartarg1 = 0 ;
  void *argp2 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:ConnorConvergenceOutput_register_output",&obj0,&obj1)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ConnorConvergenceOutput_register_output" "', argument " "1"" of type '" "FullPhysics::ConnorConvergenceOutput const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::ConnorConvergenceOutput > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::ConnorConvergenceOutput > * >(argp1);
      arg1 = const_cast< FullPhysics::ConnorConvergenceOutput * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const FullPhysics::ConnorConvergenceOutput > * >(argp1);
      arg1 = const_cast< FullPhysics::ConnorConvergenceOutput * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    int newmem = 0;
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ConnorConvergenceOutput_register_output" "', argument " "2"" of type '" "boost::shared_ptr< FullPhysics::Output > const &""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      ((FullPhysics::ConnorConvergenceOutput const *)arg1)->register_output((boost::shared_ptr< FullPhysics::Output > const &)*arg2);
...
SWIGINTERN PyObject *_wrap_delete_ConnorConvergenceOutput(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::ConnorConvergenceOutput *arg1 = (FullPhysics::ConnorConvergenceOutput *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< FullPhysics::ConnorConvergenceOutput > tempshared1 ;
  boost::shared_ptr< FullPhysics::ConnorConvergenceOutput > *smartarg1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_ConnorConvergenceOutput",&obj0)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(obj0, &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ConnorConvergenceOutput" "', argument " "1"" of type '" "FullPhysics::ConnorConvergenceOutput *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  FullPhysics::ConnorConvergenceOutput > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  FullPhysics::ConnorConvergenceOutput > * >(argp1);
      arg1 = const_cast< FullPhysics::ConnorConvergenceOutput * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  FullPhysics::ConnorConvergenceOutput > * >(argp1);
      arg1 = const_cast< FullPhysics::ConnorConvergenceOutput * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *ConnorConvergenceOutput_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_tTo_p_boost__shared_ptrT_FullPhysics__RegisterOutputBase_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::RegisterOutputBase >(*(boost::shared_ptr< FullPhysics::ConnorConvergenceOutput > *)x);
}
static void *_p_FullPhysics__ConnorConvergenceTo_p_FullPhysics__ConvergenceCheck(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::ConvergenceCheck *)  ((FullPhysics::ConnorConvergence *) x));
}
static void *_p_boost__shared_ptrT_FullPhysics__ConnorConvergence_tTo_p_boost__shared_ptrT_FullPhysics__ConvergenceCheck_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::ConvergenceCheck >(*(boost::shared_ptr< FullPhysics::ConnorConvergence > *)x);
}
...
static void *_p_boost__shared_ptrT_FullPhysics__ConnorConvergence_tTo_p_boost__shared_ptrT_FullPhysics__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< FullPhysics::GenericObject >(*(boost::shared_ptr< FullPhysics::ConnorConvergence > *)x);
}
...
static void *_p_FullPhysics__ConnorConvergenceOutputTo_p_FullPhysics__RegisterOutputBase(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::RegisterOutputBase *)  ((FullPhysics::ConnorConvergenceOutput *) x));
}
...
static void *_p_FullPhysics__ConnorConvergenceTo_p_FullPhysics__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FullPhysics::GenericObject *) (FullPhysics::ConvergenceCheck *) ((FullPhysics::ConnorConvergence *) x));
}
...
static swig_type_info _swigt__p_FullPhysics__ConnorConvergence = {"_p_FullPhysics__ConnorConvergence", "FullPhysics::ConnorConvergence *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_FullPhysics__ConnorConvergenceOutput = {"_p_FullPhysics__ConnorConvergenceOutput", "FullPhysics::ConnorConvergenceOutput *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t = {"_p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t", "boost::shared_ptr< FullPhysics::ConnorConvergenceOutput > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t = {"_p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t", "boost::shared_ptr< FullPhysics::ConnorConvergence > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FullPhysics__ConnorConvergence,
  &_swigt__p_FullPhysics__ConnorConvergenceOutput,
  ...
  &_swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t,
  &_swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t,
...
static swig_cast_info _swigc__p_FullPhysics__ConnorConvergence[] = {  {&_swigt__p_FullPhysics__ConnorConvergence, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__ConnorConvergenceOutput[] = {  {&_swigt__p_FullPhysics__ConnorConvergenceOutput, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FullPhysics__ConvergenceCheck[] = {  {&_swigt__p_FullPhysics__ConvergenceCheck, 0, 0, 0},  {&_swigt__p_FullPhysics__ConnorConvergence, _p_FullPhysics__ConnorConvergenceTo_p_FullPhysics__ConvergenceCheck, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_FullPhysics__RegisterOutputBase[] = {  {&_swigt__p_FullPhysics__ConnorConvergenceOutput, _p_FullPhysics__ConnorConvergenceOutputTo_p_FullPhysics__RegisterOutputBase, 0, 0},  {&_swigt__p_FullPhysics__RegisterOutputBase, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_FullPhysics__ConvergenceCheck_t[] = {  {&_swigt__p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t, _p_boost__shared_ptrT_FullPhysics__ConnorConvergence_tTo_p_boost__shared_ptrT_FullPhysics__ConvergenceCheck_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_FullPhysics__ConvergenceCheck_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FullPhysics__ConnorConvergence,
  _swigc__p_FullPhysics__ConnorConvergenceOutput,
  ...
  _swigc__p_boost__shared_ptrT_FullPhysics__ConnorConvergenceOutput_t,
  _swigc__p_boost__shared_ptrT_FullPhysics__ConnorConvergence_t,
...
# endif
  ...
  FullPhysics::swig_type_map[FullPhysics::type_index(typeid(FullPhysics::ConnorConvergenceOutput))] =
  boost::shared_ptr<FullPhysics::SwigTypeMapperBase>(new FullPhysics::SwigTypeMapper< FullPhysics::ConnorConvergenceOutput >("boost::shared_ptr< FullPhysics::ConnorConvergenceOutput > *"));
